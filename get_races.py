...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Getting racer data from typeracer.')
    parser.add_argument('-u', '--user_name', type=str,
                        required=True, help='Enter the username of the user whose data you want to download.')
    parser.add_argument('-lr', '--last_races', type=int, required=False,
