...
st.set_page_config(page_title="Typeracer analysis", page_icon="img/icon-racer.ico", layout='centered', initial_sidebar_state='auto')
...
username = st.text_input('Type in a user name to generate user analytics', 
                         value = 'abnf',
